...
migrate((app) => {
  ...
  // Set working access rules with proper syntax
  // Use "1=1" which always evaluates to true for authenticated users
  collection.listRule = "1=1";  // Allow all authenticated users to list games
  collection.viewRule = "1=1";  // Allow all authenticated users to view games
