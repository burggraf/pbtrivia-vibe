...
migrate((app) => {
  ...
  // Fix access rules with proper PocketBase syntax
  collection.listRule = "1=1";  // Allow all authenticated users to list
  collection.viewRule = "1=1";  // Allow all authenticated users to view
