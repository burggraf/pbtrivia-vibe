...
migrate((app) => {
  ...
  // Use empty string for list/view rules to allow all authenticated users
  collection.listRule = "";  // Allow all authenticated users to list
  collection.viewRule = "";  // Allow all authenticated users to view
