    ...
    return (
      <input
        ...
        className={cn(
          ...
          "dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:ring-offset-slate-950 dark:placeholder:text-slate-400 dark:focus-visible:ring-slate-400",
          className
        )}
        ref={ref}
        {...props}
